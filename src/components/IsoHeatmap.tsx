      ...
      <div className="iso-grid iso-grid-4">
        ...
        {ZONE_ORDER.map((zone, index) => {
          ...
          if (status === "ghost") {
            return (
              <div
                key={`ghost-active-${index}`}
                className="iso-block iso-block-ghost"
                style={{ "--ghost-h": `${ghostPlaneHeight}px`, gridColumn: gc, gridRow: gr } as CSSProperties}
                aria-hidden="true"
              >
                <div className="iso-ghost-top" />
              </div>
          ...
          return (
            <div
              ...
              style={
                {
                  "--h": `${isWaiting ? 34 : height}px`,
                  "--heat": isWaiting ? "0" : norm.toFixed(3),
                  "--delay": `${index * 80}ms`,
                  gridColumn: gc,
                  gridRow: gr,
                } as CSSProperties
            ...
            >
              <div className="iso-column" aria-hidden="true">
                ...
                <div className="iso-side-label">
                  ...
                  {isWaiting ? (
                    <span className="iso-side-waiting">
                      <span className="iso-await-dot" />
                      Waiting for connection
                    </span>
                  ) : (
